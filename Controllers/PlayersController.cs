...
namespace WebApplication2.Controllers
{
    ...
    public class PlayersController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,Email,Taco")] Player player)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(Guid id, [Bind("Id,Name,Email,Taco")] Player player)
        {
            if (id != player.Id)
            {
                return NotFound();
